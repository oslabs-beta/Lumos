  ...
  <Grid container spacing={0} className="errHeader">
      ...
      {rows.map((row) => (
        ...
        >
          ...
          <Grid item xs={1} className="Errors.children">
            {row.Value}
          </Grid>
          <Grid item xs={2} className="Errors.children">
            {row.Cost}
...
const rows = [
  { Label: "Error 1", Status: 'Complete', Value: 6.0, Timestamp: date, Cost: 4.0},{ Label: "Error 2", Status: 159, Value: 6.0, Timestamp: date, Cost: 4.0},{ Label: "Error 3", Status: 159, Value: 6.0, Timestamp: date, Cost: 4.0},{ Label: "Error 4", Status: 159, Value: 6.0, Timestamp: date, Cost: 4.0},
]
