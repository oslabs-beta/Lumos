...
export default function DayButton() {
  ...
  start = start.toLocaleString(('en-us', { weekday:"long", year:"numeric", month:"short", day:"numeric"}))
  ...
  const submitHandler = (e) => {
    ...
    fetch('/metric', {
      ...
      body: JSON.stringify({startTime: test, endTime: end, metricName: 'Invocations', period: 60})
